 ...
 */
package speck.examples.multiple;

import speck.Service;
...
/**
 * This example shows how to correctly use the Speck instance API which allows for multiple services.
 * The factory method 'service()' should be statically imported from the Speck class.
 */
