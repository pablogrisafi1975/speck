...
public class ResponseBodyTest {
    ...
    public void testHELLO() {
        try {
            SpeckTestUtil.UrlResponse response = http.get(HELLO);
    ...
    public void testSPECIAL() {
        try {
            SpeckTestUtil.UrlResponse response = http.get(SPECIAL);
            assertEquals(200, response.status);
    ...
    public void testPORAKATIKAOKAO() {
        try {
            SpeckTestUtil.UrlResponse response = http.get(PORAKATIKAOKAO);
            assertEquals(200, response.status);
    ...
    public void testMAXIME() {
        try {
            SpeckTestUtil.UrlResponse response = http.get(MAXIME);
            assertEquals(200, response.status);
