...
abstract class Routable {
    ...
    public void before(Filter filter) {
        addFilter(HttpMethod.before, FilterImpl.create(SpeckUtils.ALL_PATHS, filter));
    }
    ...
    public void after(Filter filter) {
        addFilter(HttpMethod.after, FilterImpl.create(SpeckUtils.ALL_PATHS, filter));
    }
    ...
    public void afterAfter(Filter filter) {
        addFilter(HttpMethod.afterafter, FilterImpl.create(SpeckUtils.ALL_PATHS, filter));
    }
