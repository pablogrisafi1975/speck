...
public class CustomErrorPages {
    ...
    private static final System.Logger LOG = System.getLogger(CustomErrorPages.class.getName());
        ...
        if (customRenderer instanceof String) {
            ...
            try {
             ...
             // The custom page renderer is causing an internal server error.  Log exception as a warning and use default page instead
                LOG.log(System.Logger.Level.WARNING, "Custom error page handler for status code {0} has thrown an exception: {1}. Using default page instead.", status, e.getMessage());
            }
        }
