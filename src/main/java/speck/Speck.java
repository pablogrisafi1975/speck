...
/**
 * The main building block of a Speck application is a set of routes. A route is
 ...
 * Ie. one should use:
 * 'post("/books")' without the prefix 'Speck.'
 *
 * @author Per Wendel
 */
public class Speck {
    ...
    /**
     * Statically import this for redirect utility functionality, see {@link speck.Redirect}
     */
    public static final Redirect redirect = getInstance().redirect;

    /**
     * Statically import this for static files utility functionality, see {@link speck.Service.StaticFiles}
     */
     ...
     * -
     * Note: contemplate changing tonew static files paradigm {@link speck.Service.StaticFiles}
     *
     ...
     * -
     * Note: contemplate use of new static files paradigm {@link speck.Service.StaticFiles}
     *
    ...
    /**
     * Waits for the Speck server to be stopped.
