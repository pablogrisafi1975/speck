...
public abstract class ResourceUtils {
    ...
    public static boolean isUrl(String resourceLocation) {
        ...
        try {
            new URI(resourceLocation).toURL();
            return true;
    ...
    public static URL getURL(String resourceLocation) throws FileNotFoundException {
        ...
        try {
            // try URL
            return new URI(resourceLocation).toURL();
        } catch (MalformedURLException | URISyntaxException ex) {
    ...
    public static File getFile(String resourceLocation) throws FileNotFoundException {
        ...
        try {
            // try URL
            return getFile(new URI(resourceLocation).toURL());
        } catch (MalformedURLException | URISyntaxException ex) {
            // no URL -> treat as file path
     ...
     */
    public static URL extractJarFileURL(URL jarUrl) throws MalformedURLException, URISyntaxException {
        String urlFile = jarUrl.getFile();
        int separatorIndex = urlFile.indexOf(JAR_URL_SEPARATOR);
        if (separatorIndex != -1) {
            String jarFile = urlFile.substring(0, separatorIndex);
            try {
                return new URI(jarFile).toURL();
            } catch (MalformedURLException | URISyntaxException ex) {
                ...
                return new URI(FILE_URL_PREFIX + jarFile).toURL();
            }
        } else {
            return jarUrl;
        }
